...
/**
 * The mod_schedule answer created event.
 *
...
/**
 * The mod_schedule answer created event class.
 *
...
class answer_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventanswercreated', 'mod_schedule');
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'schedule_answers', 'restore' => 'answer');
    }
