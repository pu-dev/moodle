...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_schedule');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the report for the schedule activity with course module id
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'schedule', 'report', $url->out(), $this->objectid, $this->contextinstanceid);
    }
